# note: in previous examples we looked at forward and backwards propegation separately
# now we'll combine and actually update the weights using delta W found in back prop
import numpy as np
